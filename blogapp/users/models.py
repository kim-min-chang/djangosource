...
from django.contrib.auth.models import User, PermissionsMixin, AbstractUser,BaseUserManager
from django.contrib.auth.base_user import AbstractBaseUser

# AbstractBaseUser : password, last_login 필드만 가지고 있음
#       ↑
# AbstractUser : is_superuser,groups,user_permissions 필드소유
#       ↑
#  User

# User 모델에 다른 월드를 추가하고 싶다면?
# class CusetomUser(User):
    # 필드 추가 지정
